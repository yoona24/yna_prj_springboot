...
공공데이터포털(data.go.kr)에 있는 [한국장학재단_학자금지원정보(대학생)] 데이터를 활용하여 대학생 및 대학원생을 대상으로 지원하는 학자금 정보(운영기관, 상품명, 상품구분, 학자금 지원 유형, 신청대상, 신청기간, 지원금액, 지원인원 등) 제공 및 장학금 자격 확인 서비스 (https://www.data.go.kr/data/15028252/fileData.do)
